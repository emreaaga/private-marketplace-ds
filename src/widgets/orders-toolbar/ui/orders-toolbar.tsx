...
import { Info, ListFilter, Plus, RotateCcw, Search, SlidersHorizontal } from "lucide-react";

import { Button } from "@/shared/ui/atoms/button";

const OrderCreateDialog = dynamic(() => import("@/features/order-create").then((m) => m.CreateOrderDialog), {
  ssr: false,
  loading: () => null,
});
    ...
    <>
      <div className="flex w-full items-center justify-between gap-4 py-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={() => {}} variant="action" size="icon-sm">
